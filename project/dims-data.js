...
window.DKM_FLANGE = {
  ...
  // FB — z tabeli wymiarowej katalogu (25.08.2026). 030, 110, 130, 150: brak kołnierza FB.
  FB: {
...
// Wymiary przyłącza PAM-IEC — pełna lista od DKM (01.09.2026), per wielkość korpusu.
// Klucz: KORPUS → oznaczenie PAM-IEC → [N, M, P, S, b₁, t₁, s₁, D(H8)] w mm.
// N — wypust centrujący, M — rozstaw otworów, P — średnica zewnętrzna kołnierza,
// S — otwór pod śrubę, b₁/t₁ — wpust, s₁ — grubość kołnierza (zależy od korpusu), D — otwór wejściowy.
window.DKM_PAM = {
  DKM030: { '56B5':[80,100,120,6.5,3,10.4,4,9], '56B14':[50,65,80,5.5,3,10.4,4,9], '63B5':[95,115,140,9,4,12.8,4,11], '63B14':[60,75,90,5.5,4,12.8,4,11] },
  DKM040: { '56B5':[80,100,120,6.5,3,10.4,4,9], '56B14':[50,65,80,5.5,3,10.4,4,9], '63B5':[95,115,140,9,4,12.8,4,11], '63B14':[60,75,90,5.5,4,12.8,4,11], '71B5':[110,130,160,9,5,16.3,5,14], '71B14':[70,85,105,7,5,16.3,5,14] },
  DKM050: { '63B5':[95,115,140,9,4,12.8,5,11], '63B14':[60,75,90,5.5,4,12.8,5,11], '71B5':[110,130,160,9,5,16.3,5,14], '71B14':[70,85,105,7,5,16.3,5,14], '80B5':[130,165,200,11,6,21.8,5,19], '80B14':[80,100,120,7,6,21.8,5,19] },
  DKM063: { '71B5':[110,130,160,9,5,16.3,5,14], '71B14':[70,85,105,7,5,16.3,5,14], '80B5':[130,165,200,11,6,21.8,5,19], '80B14':[80,100,120,7,6,21.8,5,19], '90B5':[130,165,200,11,8,27.3,5,24], '90B14':[95,115,140,9,8,27.3,5,24] },
  DKM075: { '71B5':[110,130,160,9,5,16.3,5,14], '80B5':[130,165,200,11,6,21.8,5,19], '80B14':[80,100,120,7,6,21.8,5,19], '90B5':[130,165,200,11,8,27.3,5,24], '90B14':[95,115,140,9,8,27.3,5,24], '100B5':[180,215,250,13,8,31.3,5.5,28], '100B14':[110,130,160,9,8,31.3,5.5,28], '112B5':[180,215,250,13,8,31.3,5.5,28], '112B14':[110,130,160,9,8,31.3,5.5,28] },
  DKM090: { '80B5':[130,165,200,11,6,21.8,5,19], '80B14':[80,100,120,7,6,21.8,5,19], '90B5':[130,165,200,11,8,27.3,5,24], '90B14':[95,115,140,9,8,27.3,5,24], '100B5':[180,215,250,13,8,31.3,5.5,28], '100B14':[110,130,160,9,8,31.3,5.5,28], '112B5':[180,215,250,13,8,31.3,5.5,28], '112B14':[110,130,160,9,8,31.3,5.5,28] },
  DKM110: { '80B5':[130,165,200,11,6,21.8,6,19], '90B5':[130,165,200,11,8,27.3,6,24], '100B5':[180,215,250,13,8,31.3,6,28], '112B5':[180,215,250,13,8,31.3,6,28], '132B5':[230,265,300,13,10,41.3,6,38] },
  DKM130: { '90B5':[130,165,200,11,8,27.3,6,24], '100B5':[180,215,250,13,8,31.3,6,28], '112B5':[180,215,250,13,8,31.3,6,28], '132B5':[230,265,300,13,10,41.3,6,38] },
  DKM150: { '100/112B5':[180,215,250,13,8,31.3,6,28], '132B5':[230,265,300,13,10,41.3,6,38], '160B5':[250,300,350,19,12,45.3,6,42] }
};
window.DKM_PAM_KEYS = ['N','M','P','S','b₁','t₁','s₁','D'];
